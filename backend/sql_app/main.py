        ...
        if (item.resType == 3):
            ...
            for i in result:
                ...
                data.append({
                    ...
                    "label": i.date + "," + i.type,
                    "materialDescribe": "",
                    "coverImage": "https://calligraphy.culturedc.cn:8443/backend-api/getImage/" + i.fileName,
                    "materialPath": "https://calligraphy.culturedc.cn:8443/backend-api/getImage/" + i.fileName,
                    "audioTime": "",
                    "format": "jpg",
                    "size": s,
                    "height": h,
